...
The script will:
1. Find all `.html` and `.HTML` files in the specified directories (or the `questions/` subdirectory if none are given), excluding the `.git` directory
